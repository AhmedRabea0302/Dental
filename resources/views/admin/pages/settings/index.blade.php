                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control input-circle" name="site_lang" value="@if(app()->getLocale() == 'ar'){{ $settings->site_language }} @else english @endif" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control input-circle" name="site_address" value="{{ $settings->address}}" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control input-circle" name="site_number" value="{{ $settings->phone_number }}" >
                                </div>
                            </div>
