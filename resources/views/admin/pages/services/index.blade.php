        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>أضف خدمة</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="{{ route('admin.add_service')}}" method="post" onsubmit="return false;" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-body">
                            {{ csrf_field() }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="service_desc1_ar" rows="4" class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="service_desc1_en" rows="4" class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="service_desc2_ar" rows="4" class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="service_desc2_en" rows="4" class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="features_ar" rows="4" class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="features_en" rows="4" class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keywords_ar" class="form-control " data-role="tagsinput"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keywords_en" class="form-control " data-role="tagsinput"/>
                                </div>
                            </div>
                        ...
                        <div class="form-body">
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                @foreach($services as $services)
                                    <tr>
                                        <td><img src="{{url('storage/uploads/services') . '/' . $services->service_image_name }}" class="img-responsive center-block" style="width: 150px; height: 100px" /></td>
                                        <td>{{ $services->getDetails()->where(['service_id' => $services->id ,'lang' => app()->getLocale()])->first()->name }}</td>
                                        <td><a href="{{ route('admin.get_update_service', ['id' => $services->id]) }}" class="btn btn-info"><i class="fa fa-edit"></i> {{ trans('trans.update') }}</a></td>
                                        <td><a href="{{ route('admin.delete_service', ['id' => $services->id]) }}" class="btn btn-danger"><i class="fa fa-trash"></i> {{ trans('trans.delete') }}</a></td>
                                    </tr>
                                @endforeach
                            </table>
                            </div>
