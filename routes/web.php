...
Route::group(['namespace' => 'site'], function() {
    ...
    Route::get('/search-blogs', 'BlogController@getBlogSearch')->name('site.blog_search');
    Route::post('/add-comment/{id}', 'BlogController@postAddComment')->name('site.blog_add_comment');
